...
# Test with modjulia
# Precompiation of the modules must be disabled here


# If package is not precompiled then it will create a precompilation cache in undesired location

#import App
#AppRuntime.init_msix()
