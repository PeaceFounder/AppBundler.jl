...
try
    ...
    args = ["build", app_dir, "--build-dir=$build_dir", "--target-name=glapp", "--target-bundle=$target_bundle", "-Djuliaimg.precompile=false", "-Dwindowed=true", "-Dmsix.bootstrapper=true"]
